...
namespace MyWeb_Hub.Controllers
{
    public class HubController : Controller
    {
        ...
        public string GetRoomChatData(string roomName)
        {
            DataTable dt = new GroupChatDataBLL().GetRoomDataBLL(roomName);
            string str = DataTableToJson(dt);
            return str;
        }
        public string GetFriendsChatData(string Sender,string Receiver)
        {
            DataTable dt = new ChatDataBLL().GetFriendsDataBLL(Sender,Receiver);
            string str = DataTableToJson(dt);
            return str;
        }
        ...
        public string GetQueryFriends(string name)
        {
            DataTable dt = new UserBLL().FuzzyQueryBLL(name);
            string str = DataTableToJson(dt);
            return str;
        }
